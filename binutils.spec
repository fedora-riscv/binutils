...
Patch18: binutils-2.23.51.0.1-dwz-alt-debuginfo.patch
...
# Fix problems compiling docs using texinfo v5.
Patch20: binutils-2.23.51.0.1-texinfo-5-fixes.patch
...
* Mon Jun 10 2013 Nick Clifton <nickc@redhat.com> - 2.23.52.0.1-10
...
* Fri Jan 25 2013 Nick Clifton <nickc@redhat.com> 2.23.51.0.1-6
